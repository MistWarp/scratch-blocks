...
Blockly.InsertionMarkerManager.prototype.shouldUpdatePreviews_ = function(
  ...
  if (candidateLocal && candidateClosest) {
    ...
    // We weren't showing a preview before, but we should now.
      ...
      /* eslint-disable */console.error(...oo_tx(`3780409475_346_6_346_83_11`,'Only one of localConnection_ and closestConnection_ was set.'));
    }
  ...
  /* eslint-disable */console.error(...oo_tx(`3780409475_353_2_353_85_11`,'Returning true from shouldUpdatePreviews, but it\'s not clear why.'));
  return true;
};
...
Blockly.InsertionMarkerManager.prototype.disconnectMarker_ = function() {
  if (!this.markerConnection_) {
    /* eslint-disable */console.log(...oo_oo(`3780409475_607_4_607_63_4`,'No insertion marker connection to disconnect'));
    return;
  }
