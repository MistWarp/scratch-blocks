...
Blockly.Blocks['json_create_array'] = {
  init: function() {
    this.jsonInit({
      "message0": "empty list",
      "category": Blockly.Categories.json,
...
Blockly.Blocks['json_from_text'] = {
  init: function() {
    this.jsonInit({
      "message0": "dict from text %1",
      "args0": [
        {
          "type": "input_value",
          "name": "TEXT"
...
// New list blocks
Blockly.Blocks['list_set_to_empty'] = {
  init: function() {
    this.jsonInit({
      "message0": "set list %1 to []",
      "args0": [
        {
          "type": "field_variable",
          "name": "LIST",
...
Blockly.Blocks['list_get_as_string'] = {
  init: function() {
    this.jsonInit({
      "message0": "list %1 as string",
      "args0": [
        {
          "type": "field_variable",
          "name": "LIST",
...
Blockly.Blocks['list_get_as_json'] = {
  init: function() {
    this.jsonInit({
      "message0": "list %1 as json",
      "args0": [
        {
          "type": "field_variable",
          "name": "LIST",
